...
class FrameFaceIterableDataset(IterableDataset):
    ...
    def __init__(self,
        ...
        self.seed0 = int(seed) if seed is not None else np.random.randint(0, 2**31 - 1)
        ...
        self.df_real = self.df[self.df['label'] == True]
        self.df_fake = self.df[self.df['label'] == False]
